...
//This class would test login success

public class HerokuappLoginSuccess {
	...
	public void loginSuccess() throws Exception {
		...
		driver.findElement(By.name("password")).sendKeys(property.getProperty("rightPassword"));
		...
		String expectedResult=property.getProperty("successMsg");
